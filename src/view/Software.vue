...
const customerList = [
  {
    type: 1,
    pContent: [
      "东铭绿能（上海）科技有限公司战略合作伙伴 Ceram 公司作为欧美第一家蜂窝催化剂生产商，全球业绩数超过4000个，是最富盛名/市场占有率最高的专业SCR脱硝催化剂生产厂家。自 2005 年进入中国市场，累计供货超 400 个项目，享有性能优异、使用寿命最长、长期运行经济性最佳的口碑，至今保持 0 质量纠纷或索赔官司的优良传统，成就了 Ceram 公司在业内的领先地位。",
      "在钢铁行业(包括烧结、焦化和酸洗应用)，Ceram 拥有无与伦比的全球最多业绩，共有 100 多个。在低温应用领域，在中国就有 200 多个垃圾焚烧脱硝业绩，运行温度为 180-230℃之间。",
      "在宁钢焦化，设计应用温度为 170℃，已持续良好运行超 8 年。在南钢，Ceram 公司作为南钢第一烧结厂 2*180m2 烧结机供货商，至今，该批催化剂已运行 7 年，远超性能保证值 3 年，也获得了业主的高度好评和一致认可。期间，Ceram 公司也一直和工厂保持联系，进行催化剂的抽样检测，确保了良好的售后服务。",
      "Ceram 公司在低温和/或钢铁行业，拥有全球最丰富的经验，和最优质的产品质量。",
    ],
    info: [
      {
        title: "",
  ...
  },
  {
    type: 3,
    pContent: [
      "技术源于研发与产品创新领先的丹麦，专业从事研发、设计、制造最具有挑战性的水液压领域的轴向柱塞泵，阀，能量回收技术等高效节能减排产品。",
    ],
    info: [
      {
